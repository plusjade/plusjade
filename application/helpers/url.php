...
class url_Core {
	...
	public static function base($index = FALSE, $protocol = FALSE)
	{
		...
		// Load the site domain
				//  ---------  THIS IS AN EDIT BY JADE --------   $site_domain = (string) Kohana::config('core.site_domain', TRUE);
		$site_domain = (string) $_SERVER['HTTP_HOST'];
	...
	/* return the current path to public_images
	 *
	 */
