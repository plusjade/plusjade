...
<div id="menu">
		<?php View::factory("_global/menu", array('load_custom' => TRUE))->render(true);?>
</div>
<!-- end header -->
<hr />
<!-- start latest post -->
<div id="latest-post" class="wide-post">
	...
	<div class="entry"> 
		...
		<!--
		<img src="images/img07.jpg" alt="" width="114" height="114" class="left" />
		<p>This is <strong>Radiance</strong>, a free, fully standards-compliant CSS template designed by <a href="http://www.freecsstemplates.org/">Free CSS Templates</a>. This free template is released under a <a href="http://creativecommons.org/licenses/by/2.5/">Creative Commons Attributions 2.5</a> license, so you're pretty much free to do whatever you want with it  (even use it commercially) provided you keep the links in the footer  intact. Aside from that, have fun with it :)</p>
		<p>This template is also available as a <a href="http://www.freewpthemes.net/preview/radiance/">WordPress theme</a> at <a href="http://www.freewpthemes.net/">Free WordPress Themes</a>. The photo on this template is from <a href="http://www.pdphoto.org/">PDPhoto.org</a>. </p>
		<p>&nbsp;</p>
		<p class="links"> <a href="#" class="date">October 7th, 2007</a> &nbsp;&nbsp;&nbsp;&nbsp; <a href="#" class="author">Free CSS Templates</a> &nbsp;&nbsp;&nbsp;&nbsp; <a href="#" class="comments">14 Comments</a> ( <a href="#" class="feeds">RSS</a> ) </p>
		-->
	</div>
