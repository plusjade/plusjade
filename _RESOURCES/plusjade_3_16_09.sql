...
--
-- Host: localhost
-- Generation Time: Mar 16, 2009 at 11:46 PM
...
(79, 1, 1, 'avatar.jpg', 'I''m happy', 1),
(78, 1, 1, 'BEAR.jpg', 'Bear! <3', 4),
(85, 1, 1, 'image5.jpg', 'Leaves', 0),
(90, 1, 1, 'snapshot3.jpg', '<3', 6),
(76, 1, 1, 'cali.jpg', 'Cawichu', 2),
(83, 1, 1, 'image2.jpg', 'Red', 7),
(92, 1, 1, 'sample.jpg', 'web emb website', 3);
...
(100, 1, 1, 5, 'aim', '', 3, 'no'),
(99, 1, 1, 3, 'Address', 'Alhambra, CA', 0, 'yes');
...
(24, 1, 'examples', 1, 'Showroom', '+Jade website examples', 'asafsadfsa', '<div style="margin-left: 40px;">Here is a quick sample of some of our client accounts we currently manage.<br>We are still in development mode so we are focusing on customer satisfaction rather than customer acquisition. If these sites look like something you could use, just give us a call!<br></div>', 'To edit this page, login and click "edit page"!', ''),
...
(71, 1, 'themes', 1, 'Showroom', '+Jade Proffessional theme creation for your busine', '+Jade Proffessional theme creation for your busine', '', '', ''),
...
(68, 1, 'tools', 1, 'Showroom', '', '', '', '', ''),
(78, 40, 'home', 1, '', 'Sam & Leon Furniture Co - Fine Oriental Furniture ', 'Fine Oriental Furniture & Accessories in Pasadena, CA and the greater San Gabriel Valley.', '', '<p><h2>My Home Page!</h2></p>', ''),
(79, 40, 'contact', 1, 'Contact', 'Contact us : Sam & Leon Furniture Co', '', '', '', ''),
...
(77, 1, 'test', 1, 'Album', 'Album Test page', 'Tee Hee !', '', '', '');
...
(1, 24, 1, 'blah', 'list', ''),
(2, 68, 1, 'Themes', 'gallery', ''),
(3, 71, 1, 'Tools', 'gallery', '');
...
INSERT INTO `showroom_items` (`id`, `fk_site`, `parent_id`, `name`, `intro`, `body`, `price`, `position`, `image`) VALUES
(1, 1, 1, 'http://plusjade.com', '+Jade (this site) is entirely created and run by our system. We want to be our own example, so rather than custom coding a site for our own needs, why not use the product we belive in?', '', 500, 0, '1233651188.jpg'),
...
INSERT INTO `slide_panels` (`id`, `page_id`, `fk_site`, `view`, `params`) VALUES
(1, 19, 1, 'standard', '');
...
(9, 0, 2, 'Business', 'Custom branded apparel to give your business the professional look it deserves. \nWe offer all the top brands in a wide range of colors. Give us your logo, wait 10 days,\nand enjoy!', 0),
(10, 0, 2, 'Retail', 'Personal solutions and consultations to launch a retail clothing campaign.\nWhether you are an established business or planning your first launch, we offer personal experience-backed solutions at reasonable prices, and even better quality offerings.', 0),
(11, 0, 2, 'Branding', 'Promotional products meet high end. We offer unique solutions to keeping your companies high value image, while reasonably giving away promotional branding products.', 0),
(16, 0, 2, 'Schools', 'Custom school wear for senior packages, and hoodies galore. We specialize in unique custom applications of tackle twill and college style hoodies.\n<p>\nWe also incorporate mixed media such printed designs over embroidery for a truly one-of-a-kind finish.\n</p>', 0),
(22, 0, 16, 'benefit', '<div id="shell">\n	<div id="headline">San Gabriel Valley motorcycle maintenance, repair, and parts!</div>\n		\n</div>', 0),
(23, 0, 16, 'TEE HEE!', 'adfasfd<br>', 0),
(24, 0, 19, 'one benefit', 'yippy<br>', 0),
(25, 0, 19, 'two benefit', 'skippy<br>', 0);
...
(1, 1, 'jade@jade.com', 'jade', '62a69de60a2d1bb13bf2edf2bd976870b72597985683325617', 'bvAkj6hoXDQrly9c9UTFZh6IthD7NuGs', 389, 1237261889),
