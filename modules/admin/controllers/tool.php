...
class Tool_Controller extends Controller {
  ...
  function __construct()
  {
    ...
    $this->tool_id = (isset($_GET['tool_id']))
      ? valid::id_key($_GET['tool_id']) 
      : NULL;
        
    $this->page_id = (isset($_GET['page_id']))
      ? valid::id_key($_GET['page_id']) 
      : NULL;
  }
 ...
 */
  public function create_to_page()
  {
    ...
    $tools = ORM::factory('system_tool')
      ...
      ->find_all();
    $view = new View('tool/new_tool');
    $view->tools_list = $tools;
    $view->page_id = $this->page_id;
    die($view);
  }
 ...
 */  
  public function delete()
  {
    ...
    # delete all page instances of this tool first
    $db = Database::instance();  
    $db->delete('pages_tools', array('tool_id' => $this->tool_id, 'fk_site' => $this->site_id));    
