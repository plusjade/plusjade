			...
			<div class="toolkit_wrapper">
				<ul class="toolkit_dropdown">
					...
					<?php if(!$protected):?>
						...
						<li><span class="icon asterisk">&#160; &#160; </span> <a href="/get/tool/remove/<?php echo "$guid/$page_id"?>" rel="facebox" title="Removes tool from this page but does not delete the tool.">Remove</a></li>
					<?php endif;?>
					
					
					<?php if('account' != $name):?>
						<li><span class="icon cross">&#160; &#160; </span> <a href="/get/tool/delete/<?php echo $guid?>" class="js_admin_delete" rel="guid_<?php echo $guid?>" title="Delete this tool entirely from all pages.">Delete</a></li>	
					<?php endif;?>
