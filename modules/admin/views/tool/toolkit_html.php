    ...
    <div class="actions_wrapper">
      ...
      <div class="toolkit_wrapper">
        <ul class="toolkit_dropdown">
          ...
          <?php if('account' != $name):?>
            <li><span class="icon cross">&#160; &#160; </span> <a href="/get/tool/delete?tool_id=<?php echo $tool_id?>" class="js_admin_delete" rel="tool_<?php echo $tool_id?>" title="Delete this tool entirely from all pages.">Delete</a></li>  
          <?php endif;?>
