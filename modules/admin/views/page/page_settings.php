...
?>
	...
	<div class="common_full_panel fieldsets">	
		...
		<div class="common_half_right">
			...
			<br/><input type="text" name="page_name" value="<?php echo $filename?>" class="auto_filename" style="width:350px" maxlength="50">		
			
			<div id="page_exists" class="aligncenter error_msg"></div>	

			<br/><br/>
			<b>Page Title</b>
			<br/><input type="text" name="title" value="<?php echo $page->title?>" style="width:350px">
			<br/><br/>
