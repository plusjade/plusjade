...
<div id="breadcrumb_wrapper">
	<a href="<?php echo url::site("$page_name/category/$category")?>"><?php echo $category?></a> &#8594; <span>all</span>
</div>
...
<div class="category_posts">
	...
	foreach($category_posts as $post)
	{
		...
		<div class="thread_item">
			...
			<div class="summary">
				<div><a href="<?php echo url::site("$page_name/view/$post->id")?>" class="load_post_view"><?php echo $post->title?></a></div>
				<br>
				<div>
