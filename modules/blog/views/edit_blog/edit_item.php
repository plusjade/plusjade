...
<form action="/get/edit_blog/edit/<?php echo $item->id?>" method="POST" class="ajaxForm">	
	...
	<div class="common_main_panel">
		...
		<div id="blog_params" class="toggle fieldsets">
			<b>Title</b>
			<br><input type="text" name="title" value="<?php echo $item->title?>" class="send_input" rel="text_req" style="width:400px">
			<br><br>
			<b>Url</b>
			<br><input type="text" name="url" value="<?php echo $item->url?>" class="auto_filename receive_input" rel="text_req" style="width:400px">
			<br>
			<br>
			<b>Status</b>
