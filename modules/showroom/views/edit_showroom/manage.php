...
<span class="on_close">update-showroom-<?php echo $this->pid?></span>

<div  id="common_tool_header" class="buttons">
  <button type="submit" id="link_save_sort" class="jade_positive" rel="<?php echo $this->pid?>" title="showroom">Save Category Tree</button>
...
<div class="common_left_panel">
  ...
  <ul id="actions_list">  
    ...
    <br/>
    <li><a href="/get/edit_showroom/items?pid=<?php echo $this->pid?>" id="show_items">List items</a></li>
  </ul>
</div>
...
// add a new category logic.
  $("button#add_cat").click(function(){
    ...
    $.post('/get/edit_showroom/add?pid=<?php echo $this->pid?>/',
...
// edit category logic.
  $("button#edit_cat").click(function(){
    ...
    $('.facebox .show_submit').show();
    $.post('/get/edit_showroom/edit_category?item_id='+ el_id,
...
//delegate element click actions
  $('#actions_list').click($.delegate({
    ...
    "a#edit_node": function(e) {
      ...
      $.facebox(function(){
        $.get('/get/edit_showroom/edit_category?item_id=' + el_id, 
