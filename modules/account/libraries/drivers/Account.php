...
/**
 * Abstract Account driver, must be extended by all drivers.
 *
 * $Id: Account.php 3769 2008-12-15 00:48:56Z zombor $
 *
 * @package    Account
 * @author     Kohana Team
...
abstract class Account_Driver {
	 ...
	 * @return  boolean
	 */
	abstract public function login($username, $fk_site, $password, $remember);
