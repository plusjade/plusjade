...
<div class="common_left_panel">
  ...
  <ul id="actions_list">  
    <li><a href="/get/edit_navigation/add?pid=<?php echo $tool_id?>" id="add_node">Add Child Element</a></li>
    <li><a href="/get/edit_navigation/edit?pid=" id="edit_node">Edit Element</a></li>
...
<div id="add_wrapper" class="popup_dialog fieldsets">
  ...
  <form action="/get/edit_navigation/add?pid=<?php echo $tool_id?>" method="POST" id="add_form">  
